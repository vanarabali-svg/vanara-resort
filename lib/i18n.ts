...
export function getDictionary(lang: Locale) {
  const d = {
    en: {
      menu: { about: 'About', villas: 'Villas', dine: 'Dine', experience: 'Experiences', weddings: 'Weddings', connect: 'Connect', footerLine: 'For those who listen to the ocean — not over it.' },
      layout: {
    ...
    id: {
      menu: { about: 'Tentang', villas: 'Vila', dine: 'Bersantap', experience: 'Pengalaman', weddings: 'Pernikahan', connect: 'Kontak', footerLine: 'Bagi mereka yang mendengarkan laut — bukan menenggelamkannya.' },
      layout: {
    ...
    cn: {
      menu: { about: '关于', villas: '别墅', dine: '餐饮', experience: '体验', weddings: '婚礼', connect: '联系', footerLine: '献给那些倾听海洋，而不是盖过海浪的人。' },
      layout: {
