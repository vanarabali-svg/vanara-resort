...
export function getDictionary(lang: Locale) {
  const d = {
    en: {
      menu: { about: 'About', villas: 'Villas', dine: 'Kokoon', experience: 'Experiences', weddings: 'Weddings', connect: 'Connect', footerLine: 'For those who listen to the ocean — not over it.' },
      layout: {
      ...
      home: {
        ...
        pages: {
          kokoon: { eyebrow: 'KOKOON', title: 'Cliffside dining shaped by light, flavour, and the ocean', p1: 'Kokoon brings together modern cuisine with a refined atmosphere, where French and Japanese techniques meet Mediterranean influences, complemented by locally sourced Indonesian ingredients.', p2: 'From daytime dining to sunset and evening, the setting evolves naturally, defined by flavour, setting, and atmosphere.', cta: 'Connect with Kokoon' },
          weddingsPage: { eyebrow: 'WEDDINGS', title: 'Celebrate above the ocean', p1: 'Set along the cliffs above the Indian Ocean, Vanara offers a distinctive setting for weddings and private celebrations.', p2: 'Ceremonies unfold in open-air spaces with uninterrupted views, where the light transitions naturally into sunset and evening.', p3: 'Each celebration is shaped by the setting, with a focus on atmosphere, space, and seamless flow.', cta: 'Start planning your wedding' }
        }
      }
    },
    id: {
      menu: { about: 'Tentang', villas: 'Vila', dine: 'Kokoon', experience: 'Pengalaman', weddings: 'Pernikahan', connect: 'Kontak', footerLine: 'Bagi mereka yang mendengarkan laut — bukan menenggelamkannya.' },
      layout: {
        ...
        footerContact: 'Kontak', footerQuickLinks: 'Tautan Cepat', footerInformation: 'Informasi', factsheet: 'Lembar Fakta', terms: 'Syarat & Ketentuan', privacy: 'Kebijakan Privasi', legal: 'Pemberitahuan Hukum', weddings: 'Pernikahan', dining: 'Kokoon', experiences: 'Pengalaman', openMap: 'Buka peta', getDirections: 'Petunjuk arah', social: 'Media sosial',
      },
      home: {
        ...
        pages: {
          kokoon: { eyebrow: 'KOKOON', title: 'Bersantap di tebing yang dibentuk oleh cahaya, rasa, dan samudra', p1: 'Kokoon menghadirkan kuliner modern dalam suasana elegan, saat teknik Prancis dan Jepang bertemu pengaruh Mediterania serta bahan lokal Indonesia.', p2: 'Dari siang hingga matahari terbenam dan malam, suasana berkembang secara alami, ditentukan oleh rasa, setting, dan atmosfer.', cta: 'Hubungi Kokoon' },
          weddingsPage: { eyebrow: 'PERNIKAHAN', title: 'Merayakan di atas samudra', p1: 'Terletak di tebing di atas Samudra Hindia, Vanara menawarkan setting khas untuk pernikahan dan perayaan privat.', p2: 'Upacara berlangsung di ruang terbuka dengan pemandangan tanpa batas, saat cahaya beralih alami menuju senja dan malam.', p3: 'Setiap perayaan dibentuk oleh tempatnya, dengan fokus pada atmosfer, ruang, dan alur yang mulus.', cta: 'Mulai rencanakan pernikahan Anda' }
        }
      }
    },
    ru: {
      menu: { about: 'О курорте', villas: 'Виллы', dine: 'Kokoon', experience: 'Впечатления', weddings: 'Свадьбы', connect: 'Контакты', footerLine: 'Для тех, кто слушает океан — а не перекрикивает его.' },
      layout: {
        openMenu: 'Открыть меню', changeLanguage: 'Изменить язык', reserve: 'Бронирование', languageTitle: 'Язык', languageHint: 'Выберите языковую версию сайта.', closeLanguage: 'Закрыть выбор языка', directBooking: 'Прямое бронирование', reserveStay: 'Забронируйте проживание', reserveSub: 'Выберите даты и количество гостей, затем перейдите на страницу прямого бронирования.', checkIn: 'Заезд', checkOut: 'Выезд', rooms: 'Номера', adults: 'Взрослые', children: 'Дети', selecting: 'Выбор', nightStay: 'ночей', room: 'номер', roomsWord: 'номеров', adult: 'взрослый', adultsWord: 'взрослых', checkAvailability: 'Проверить наличие', closeBooking: 'Закрыть окно бронирования', cookieEyebrow: 'Политика cookie', cookieTitle: 'Более спокойный и удобный визит', cookieText: 'Мы используем cookie, чтобы улучшать работу сайта, запоминать предпочтения и понимать, как гости взаимодействуют с сайтом.', readPolicy: 'Читать политику', decline: 'Отклонить', accept: 'Принять', footerContact: 'Контакты', footerQuickLinks: 'Быстрые ссылки', footerInformation: 'Информация', factsheet: 'Фактшит', terms: 'Условия и положения', privacy: 'Политика конфиденциальности', legal: 'Юридическая информация', weddings: 'Свадьбы', dining: 'Kokoon', experiences: 'Впечатления', openMap: 'Открыть карту', getDirections: 'Маршрут', social: 'Социальные сети',
      },
      home: {
        ...
        pages: {
          kokoon: { eyebrow: 'KOKOON', title: 'Ресторан на утёсе, сформированный светом, вкусом и океаном', p1: 'Kokoon объединяет современную кухню и утончённую атмосферу, где французские и японские техники встречаются со средиземноморскими влияниями и локальными индонезийскими продуктами.', p2: 'От дневного времени до заката и вечера пространство естественно меняется, раскрывая вкус, обстановку и настроение.', cta: 'Связаться с Kokoon' },
          weddingsPage: { eyebrow: 'СВАДЬБЫ', title: 'Празднуйте над океаном', p1: 'Расположенный на утёсах над Индийским океаном, Vanara предлагает выразительное пространство для свадеб и частных торжеств.', p2: 'Церемонии проходят в открытых пространствах с бескрайними видами, где свет естественно переходит в закат и вечер.', p3: 'Каждое событие формируется самим местом, с акцентом на атмосферу, пространство и плавность.', cta: 'Начать планирование свадьбы' }
        }
      }
    },
    cn: {
      menu: { about: '关于', villas: '别墅', dine: 'Kokoon', experience: '体验', weddings: '婚礼', connect: '联系', footerLine: '献给那些倾听海洋，而不是盖过海浪的人。' },
      layout: {
        openMenu: '打开菜单', changeLanguage: '切换语言', reserve: '预订', languageTitle: '语言', languageHint: '选择网站语言版本。', closeLanguage: '关闭语言选择', directBooking: '直接预订', reserveStay: '预订您的入住', reserveSub: '选择日期和入住人数，然后前往我们的直订页面。', checkIn: '入住', checkOut: '退房', rooms: '房间', adults: '成人', children: '儿童', selecting: '正在选择', nightStay: '晚入住', room: '间房', roomsWord: '间房', adult: '位成人', adultsWord: '位成人', checkAvailability: '查看房态', closeBooking: '关闭预订窗口', cookieEyebrow: 'Cookie 政策', cookieTitle: '更从容、更顺畅的访问体验', cookieText: '我们使用 Cookie 来提升性能、记住偏好，并了解访客如何浏览网站。', readPolicy: '阅读政策', decline: '拒绝', accept: '接受', footerContact: '联系', footerQuickLinks: '快速链接', footerInformation: '信息', factsheet: '资料表', terms: '条款与条件', privacy: '隐私政策', legal: '法律声明', weddings: '婚礼', dining: 'Kokoon', experiences: '体验', openMap: '打开地图', getDirections: '获取路线', social: '社交媒体',
      },
      home: {
        ...
        pages: {
          kokoon: { eyebrow: 'KOKOON', title: '由光线、风味与海洋塑造的悬崖餐饮体验', p1: 'Kokoon 将现代料理与精致氛围结合，在法式与日式技法中融入地中海灵感，并搭配本地印尼食材。', p2: '从白昼到日落再到夜晚，这里的氛围自然变化，由风味、场景与气息共同定义。', cta: '联系 Kokoon' },
          weddingsPage: { eyebrow: '婚礼', title: '在海洋之上庆祝', p1: 'Vanara 坐落于印度洋之上的悬崖边，为婚礼与私享庆典提供了独特场地。', p2: '仪式在开阔的户外空间展开，伴随无边海景，光线自然过渡到日落与夜晚。', p3: '每一场庆典都由场地本身塑造，聚焦氛围、空间与流畅感。', cta: '开始策划您的婚礼' }
        }
      }
    }
  } as const
