    ...
    <div className="home">
      ...
      <section className="section sectionIntro">
        <div className="container">
          ...
          <div className="copy">
            <p>
              Perched above the Indian Ocean, Vanara is shaped by wind, stone,
              and warm light — a retreat where architecture dissolves into
              landscape and time slows to a breath.
            </p>
            <p>
              Private villas open to sea air; pathways lead to shaded courts,
              cliffside pools, and restorative spaces. Everything is
              intentional: calm lines, natural textures, and moments of silence
              between waves.
            </p>
            <p>
              Here, luxury is not loud. It is felt in spaciousness, in careful
              service, and in the way each view is framed — sunrise over water,
              afternoon shade across stone, and evenings that arrive softly.
            </p>
          </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="copy">
            <p>
              Vanara is built around a simple idea: the ocean is the main event.
              Interiors remain quiet so nature can speak — warm neutrals,
              natural textures, and soft edges that invite you to slow down.
            </p>
            <p>
              Days are intentionally unhurried. You can do very little and feel
              completely full — a long swim, a spa ritual, a meal by
              candlelight, then silence.
            </p>
          </div>
          <div className="rule" />
        </div>
          ...
          <div className="grid3">
            <a className="card" href="/accommodation">
              ...
              <p className="cardText">
                Minimal interiors, warm stone, soft linen — designed to
            ...
            <a className="card" href="/spa">
              ...
              <p className="cardText">
                Slow therapies, ocean minerals, and restorative heat — guided by
                quiet expertise.
              </p>
            ...
            <a className="card" href="/dine">
              ...
              <p className="cardText">
                Fire, salt, and local harvests — elegant meals that feel
                effortless.
              </p>
      ...
      <section className="section sectionGallery">
        <div className="container">
          ...
          <div className="copy" style={{ marginTop: 22 }}>
            <p>
              A palette of sand, stone, and sea. Minimalism here is not an
              aesthetic — it is a way to create room for breath, light, and the
              quiet rhythm of tides.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="split">
            <div>
              ...
              <div className="copy">
                <p>
                  Sunset cliff walks, ocean rituals, private dining, and guided
                  stillness — choose a rhythm that feels like you.
                </p>
                <p>
                  Whether you arrive to celebrate or simply to disappear for a
                  while, every detail is tailored: the timing, the tone, the
                  temperature of a room at night.
                </p>
              </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="copy">
            <p>
              Every element of the stay is made to feel effortless: discreet
              arrivals, in-villa dining, bespoke itineraries, and service that
              anticipates without interrupting.
            </p>
          </div>
          ...
          <div className="grid3">
            <div className="card" style={{ cursor: "default" }}>
              ...
              <p className="cardText">
                Private arrivals, luggage handled quietly, timing built around
                your flight.
              </p>
            ...
            <div className="card" style={{ cursor: "default" }}>
              ...
              <p className="cardText">
                Villas designed for privacy, with ocean air and soft light at
                every hour.
              </p>
            ...
            <div className="card" style={{ cursor: "default" }}>
              ...
              <p className="cardText">
                Warm, attentive, and invisible when you want it to be.
              </p>
          ...
          <div className="grid2">
            <div className="panel">
              ...
              <p className="panelText">
                A quiet edge of the island — limestone cliffs, turquoise water,
                and warm evenings. Transfers and curated arrivals available upon
                request.
              </p>
              <p className="panelText">
                Close enough for exploration, far enough to feel private. We
                can arrange drivers, surf breaks, temple visits, and hidden
                coastal paths.
              </p>
            ...
            <div className="panel">
              ...
              <p className="panelText">
                Seasonal openings, villa stories, and experiences — sent rarely,
                always calm.
              </p>
              <p className="panelText">
                Receive first access to limited dates and new rituals as they
                are introduced.
              </p>
