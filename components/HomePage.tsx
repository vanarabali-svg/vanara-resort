...
function ExperienceMosaicGrid({ lang }: { lang: Locale }) {
  ...
  const items = useMemo(() => [
    { src: '/experience-honeymoon.webp', alt: t.home.mosaic.honeymoon, title: t.home.mosaic.honeymoon, size: 'hero' },
    { src: '/experience-dining.webp', alt: t.home.mosaic.dining, title: t.home.mosaic.dining, size: 'square' },
    { src: '/experience-sunset.webp', alt: t.home.mosaic.sunset, title: t.home.mosaic.sunset, size: 'tall' },
    { src: '/experience-paragliding.webp', alt: t.home.mosaic.paragliding, title: t.home.mosaic.paragliding, size: 'square' },
    { src: '/experience-yoga.webp', alt: t.home.mosaic.yoga, title: t.home.mosaic.yoga, size: 'portrait' },
    { src: '/experience-nunggalan.webp', alt: t.home.mosaic.beach, title: t.home.mosaic.beach, size: 'portrait' },
  ], [t])
...
export default function HomePage({ lang }: { lang: Locale }) {
  ...
  return <div className="home"><section className="hero hero--video" aria-label="Hero"><div className="heroVideo" aria-label="Vanara hero media">{heroVideoOk ? <video key={`hero-${lang}`} ref={heroVideoRef} className="heroVideoEl" autoPlay muted playsInline loop preload="metadata" controls={false} disablePictureInPicture poster="/hero-poster.jpg" onError={() => { setHeroVideoOk(false) }} onCanPlay={() => { setHeroVideoOk(true) }}><source src="/hero.mp4" type="video/mp4" /></video> : <img className="heroVideoFallback" src="/hero-fallback.jpg" alt="Vanara Resort & Spa" />}</div><div className="heroShade" aria-hidden="true" /><div className="heroContent"><div className="heroKicker">{t.home.heroKicker}</div><h1 className="heroTitle">VANARA RESORT &amp; SPA</h1></div></section>
    ...
    <section className="section sectionYoga"><div className="container"><div className="split split--rev"><div className="imagePlaceholder revealBlock" aria-label="Experience image"><img className="experienceImg" src="/experiences-main.webp" alt="Experiences at Vanara" /></div><div><div className="eyebrow">{t.home.expEyebrow}</div><h3 className="h3">{t.home.expTitle}</h3><div className="copy"><p>{t.home.expP1}</p><p>{t.home.expP2}</p></div></div></div><ExperienceMosaicGrid lang={lang} /></div></section>
    <section className="section sectionWeddings" id="weddings"><div className="container"><div className="split split--rev"><div className="imagePlaceholder revealBlock" aria-label="Wedding image"><img className="experienceImg" src="/wedding.webp" alt="Wedding at Vanara" /></div><div><div className="eyebrow">{t.home.weddingsEyebrow}</div><h3 className="h3">{t.home.weddingsTitle}</h3><div className="copy"><p>{t.home.weddingsP1}</p><p>{t.home.weddingsP2}</p><p>{t.home.weddingsP3}</p></div><a className="textCta" href={withLang(lang, '/weddings')}>{t.home.weddingsCta}</a></div></div></div></section>
